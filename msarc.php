...
<html>
	...
	<body class="back">
		...
		<p>
			<h2><font face="Times New Roman" color = "black">Msc in Architecture</a>
			<a href="msec.php"><img src="right.png" align="right" hspace="20"></a><a href="mscs.php"><img src="left.png" align="right" ></a>
			</h2>
		</p>
		<p align = justify>
		...
		<h3><b>Introduction</b></h3>
			<h4>This MSc is designed to respond to the significant environmental impact of buildings, which account for around 34% of all energy use and 25% of all CO2 emissions worldwide. In more developed economies, this is significantly higher: UK buildings account for nearly 46% of all energy use and 39% of all carbon emission.As a result, there is a need for construction professionals, and building designers in particular, who can create buildings with a low carbon footprint and reduced environmental impact.
			</p>
...
<h3><b>Program Options and Featues</b></h3>
			...
			<li>New opportunities to progress into areas such as research and innovation in architecture which will be possible following the completion of this course.</li>
			</ul>
...
assessment and environmental issues.</li>
		...
		<a href="http://www.masterstudies.com/Masters-Degree/Architecture/" target = "_blank">	
